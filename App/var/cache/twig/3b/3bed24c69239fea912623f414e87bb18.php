...
class __TwigTemplate_0f8bd862b007b4b95cf9e9de0dd56449 extends Template
{
        ...
        <section class=\"offers-section\">
            <header class=\"offers-header\">
                ...
                <div class=\"offers-actions\">
                    ...
                    {% if canCreateOffer %}
                        <a href=\"/offres/create\" class=\"create-btn\">
                            <svg viewBox=\"0 0 24 24\" width=\"20\" height=\"20\" style=\"margin-right: 8px;\">
                                <path d=\"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z\" fill=\"currentColor\"/>
                            </svg>
                            Créer une offre
...
{% block javascripts %}
    {{ parent() }}
    <script> const offerType = \"{{ offerType }}\"; </script>
    <script src=\"/assets/js/stages.js\" defer></script>
{% endblock %}
...
{% endblock %}
", "offers/stages.html.twig", "C:\\Users\\Asha\\Documents\\GitHub\\Panikpa\\App\\templates\\offers\\stages.html.twig");
    }
}
